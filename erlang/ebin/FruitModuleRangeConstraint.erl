...
%% Purpose: Encoding and decoding of the types in FruitModuleRangeConstraint.

-module('FruitModuleRangeConstraint').
-moduledoc false.
-compile(nowarn_unused_vars).
-dialyzer(no_improper_lists).
-dialyzer(no_match).
-include("FruitModuleRangeConstraint.hrl").
-asn1_info([{vsn,'5.3.1'},
            {module,'FruitModuleRangeConstraint'},
...
Enc2@bits@sub = Enc2@bits - 4,
if Enc2@bits@sub bsr 1 =:= 0 ->
[<<0:1,Enc2@bits@sub:1>>|Enc2@bs];
Enc2@bits < 128 ->
...
{V1@V11,V1@Buf12}  = {decode_named_bit_string(V1@V0, [{apple,0},{orange,1},{grape,2},{banana,3},{kiwifruit,4}]),V1@Buf1},
{V1@V11,V1@Buf12}
end,
...
if Enc1@bits@sub bsr 1 =:= 0 ->
[<<0:1,Enc1@bits@sub:1>>|Enc1@bs];
Enc1@bits < 128 ->
...
bit_string_name2pos_1([kiwifruit | T]) ->
